...
public class RevokerFactoryBean implements FactoryBean, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        //初始化Netty Channel
        //key ares.remoting.test.HelloService value provideservice
        ...
        this.serviceObject = proxyFactory.getProxy2(targetInterface);

        //将消费者信息注册到注册中心
        InvokerService invoker = new InvokerService();
        invoker.setServiceItf(targetInterface);
        invoker.setRemoteAppKey(remoteAppKey); //ares
        invoker.setGroupName(groupName);//default
